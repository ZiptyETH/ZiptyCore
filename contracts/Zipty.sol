...
contract Zipty is PanamaZonesManager, Initializable, ERC721Upgradeable, ERC721EnumerableUpgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    function initialize(Province[] memory _provinces, District[] memory _districts, Corregimiento[] memory _corregimientos) initializer public {
        __ERC721_init("Zipty", "ZPTY");
        __ERC721Enumerable_init();
        __Ownable_init();
        __UUPSUpgradeable_init();
        __PanamaZonesManager_init(_provinces, _districts, _corregimientos);
    }
